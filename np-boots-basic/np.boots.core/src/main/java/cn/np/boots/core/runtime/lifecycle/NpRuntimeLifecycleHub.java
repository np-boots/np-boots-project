...
import cn.np.boots.core.runtime.lifecycle.callback.NpRuntimeLifecycleCallback;
import cn.np.boots.core.runtime.lifecycle.callback.NpRuntimeLifecycleCallbackHub;
...
@Slf4j
@Getter
public class NpRuntimeLifecycleHub implements ImportBeanDefinitionRegistrar, BeanFactoryAware {
    ...
    private NpRuntimeLifecycleCallbackHub callbackHub = NpRuntimeLifecycleCallbackHub.getInstance();
